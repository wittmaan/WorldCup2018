...
shinyUI(navbarPage(
  title = 'FIFA World Cup 2018 Prediction',
  tabPanel('Explanation',
           p('This is a shiny app that uses bookmaker betting odds (see tab \'Betting Odds\') to calculate abilities and probabilities of 
             the 32 teams of the FIFA World Cup 2018.'),
           br(),
  ...
  tabPanel('Bookmaker consensus rating',
           p('FIFA World Cup 2018 winning probabilities from the bookmaker consensus rating'),
           showOutput("chart", "polycharts"),
           p('Bookmaker consensus rating for the FIFA World Cup 2018, obtained from 22 online
